/**
 * Componente GirHorarios - Horarios de la carrera Gestión Integral del Riesgo
 * 
 * Desarrollé esta página para mostrar de forma organizada los horarios de cursada
 * de la carrera GIR, distribuidos por año académico. La información está estructurada
...
export class GirHorarios {
  ...
  /**
   * Horarios completos de la carrera GIR organizados por año
   * 
